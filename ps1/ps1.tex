...
\begin{itemize}
\item Data records are excluded from the dataset based whether the following variables take the noted values \textit{as found in the data manual}. %TODO: insert table here with values.
